...
-(id)initWithFrame:(CGRect)frame Data:(NSArray *)dataArr
{
    ...
    if (self) {
        ...
        self.frame = CGRectMake(10,([UIScreen mainScreen].bounds.size.height - self.ViewHeight)/2, self.ViewWidth, self.ViewHeight);
    }
    return self;
}
...
-(UIView *)titleView
{
    ...
    else
    {
        ...
        [btn setTitleColor:RGBA(251, 166, 84, 1) forState:UIControlStateNormal];
