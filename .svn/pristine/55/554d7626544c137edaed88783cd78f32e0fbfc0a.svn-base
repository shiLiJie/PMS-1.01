...
#define kNGDefaultTitleColor                [UIColor colorWithRed:106/255.0f green:121/255.0f blue:128/255.0f alpha:1];
...
+ (NGTabBarItem *)itemWithTitle:(NSString *)title image:(UIImage *)image simage:(UIImage *)simage{
    NGTabBarItem *item = [[NGTabBarItem alloc] initWithFrame:CGRectZero];
...
+ (NGTabBarItem *)itemWithimage:(UIImage *)image simage:(UIImage *)simage{
...
- (void)layoutSubviews {
    ...
    if (self.image != nil) {
        ...
        self.titleLabel.frame = CGRectMake(0.f, textTop+5, self.bounds.size.width, self.titleLabel.font.lineHeight);
...
- (void)drawRect:(CGRect)rect {
    ...
    if (self.image != nil) {
        ...
        if (_selectedByUser) {
            ...
            //画背景颜色
            CGContextSetRGBFillColor(context, 31/255.0f, 32/255.0f, 46/255.0f, 0);
//            
//            CGContextFillRect(context, self.bounds);
            ...
            CGContextClipToMask(context, imageRect, [self.Simage CGImage]);
...
//            CGContextSetRGBStrokeColor(context, 31/255.0f, 32/255.0f, 46/255.0f, 1.0);
...
//            CGContextStrokePath(context);
            ...
            CGContextDrawImage(context, imageRect, self.Simage.CGImage);
        } else {
            //画背景颜色
            CGContextSetRGBFillColor(context, 31/255.0f, 32/255.0f, 46/255.0f, 0);
...
- (UIColor *)selectedImageTintColor {
    ...
    //    return _selectedImageTintColor ?: [UIColor yellowColor];
//    return _selectedImageTintColor ?: [UIColor whiteColor];
    return _selectedTitleColor ?: [UIColor colorWithRed:255/255.0f green:255/255.0f blue:255/255.0f alpha:0];
}

- (UIColor *)titleColor {
    //    return _titleColor ?: kNGDefaultTitleColor;
    return _titleColor ?: [UIColor colorWithRed:152/255.0f green:152/255.0f blue:152/255.0f alpha:0];
//    return _selectedTitleColor ?: [UIColor redColor];
