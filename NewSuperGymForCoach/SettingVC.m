...
- (void)viewDidLoad {
    [super viewDidLoad];
//    self.setTablevewi.backgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:0.5];
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (ShowPicker&&[indexPath isEqual:ShowIndex]) {
        ...
        dcell.textLabel.backgroundColor = [UIColor clearColor];
        [dcell setBackgroundColor:[UIColor colorWithRed:1 green:1 blue:1 alpha:1]];
...
- (BOOL)textFieldShouldBeginEditing:(UITextField *)textField{
    ...
    switch (tag) {
        case 101:
            sectionName=[[NSMutableArray alloc] initWithObjects:KWeek, nil];
            break;
        case 102:
        case 103:
        case 104:
        ...
        case 106:
        case 107:
            sectionName=[[NSMutableArray alloc] initWithObjects:KHour, nil];
            break;
        case 10200:
        case 10300:
        case 10400:
        ...
        case 10600:
        case 10700:
            sectionName=[[NSMutableArray alloc] initWithObjects:KMin, nil];
            break;
        case 109:
        case 110:
            sectionName=[[NSMutableArray alloc] initWithObjects:KHH, nil];
            break;
        default:
            break;
    }
